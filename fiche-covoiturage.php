    ...
    <br>
 	<table class="table table-striped table-hover table-sm">
	  <caption>
		...
		<span style="float:right;">Liste des fichiers</span>
		</caption>
				<thead>
					<tr align="center">
						<th>
				...
				<tbody>
					...
					<tr align="center">
						...
						<td>Macro Chiffrage</td>
						<td>25-07-2020 à 17h19</td>
						<td>
							<a href="" class="btn btn-outline-info"><i class="far fa-eye"></i></a>
							<a href="" class="btn btn-outline-primary"><i class="fas fa-share-alt"></i></a>
						    <a href="" class="btn btn-outline-danger"><i class="fas fa-trash-alt"></i></a>
